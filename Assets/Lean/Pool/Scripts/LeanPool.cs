...
namespace Lean.Pool {
    ...
    public static class LeanPool {
        ...
        public static T Spawn<T>(T prefab, Vector3 position, Quaternion rotation, Transform parent = null)
            ...
            GameObject clone = Spawn(prefab.gameObject, position, rotation, parent);
            return clone != null ? clone.GetComponent<T>() : null;
        }
        ...
        public static T Spawn<T>(T prefab)
            ...
            GameObject clone = Spawn(prefab.gameObject);
            return clone != null ? clone.GetComponent<T>() : null;
        }
        ...
        private static GameObject Spawn(GameObject prefab, Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays) {
            if (prefab != null) {
                ...
                if (!pool.TrySpawn(ref clone, localPosition, localRotation, localScale, parent, worldPositionStays)) return null;
                ...
                if (Links.Remove(clone)) {
                    ...
                    // This shouldn't happen
                        ...
                        Debug.LogWarning(
                            "You're attempting to spawn a clone that hasn't been despawned. Make sure all your Spawn and Despawn calls match, you shouldn't be manually destroying them!", clone);
                    }
                }
        ...
        public static void DespawnAll() {
            foreach (LeanGameObjectPool instance in LeanGameObjectPool.Instances) {
                instance.DespawnAll();
            }
