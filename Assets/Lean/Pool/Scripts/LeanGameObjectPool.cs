...
namespace Lean.Pool {
    ...
    public class LeanGameObjectPool : MonoBehaviour, ISerializationCallbackReceiver {
        ...
        [FSA("Prefab")] [SerializeField] private GameObject prefab;
        ...
        [FSA("Notification")] [SerializeField] private NotificationType notification = NotificationType.IPoolable;
        ...
        [FSA("Strategy")] [SerializeField] private StrategyType strategy = StrategyType.ActivateAndDeactivate;
        ...
        [FSA("Preload")] [SerializeField] private int preload;
        ...
        [FSA("Capacity")] [SerializeField] private int capacity;
        ...
        [FSA("Recycle")] [SerializeField] private bool recycle;
        ...
        [FSA("Persist")] [SerializeField] private bool persist;
        ...
        [FSA("Stamp")] [SerializeField] private bool stamp;
        ...
        [FSA("Warnings")] [SerializeField] private bool warnings = true;
